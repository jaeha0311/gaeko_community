import { ArrowLeft, Search, Plus, Minus, Home, MapPin, Bell, User } from "lucide-react"
...
export default function Component() {
  return (
    <div className="min-h-screen bg-[#f2f2f5] flex flex-col max-w-sm mx-auto">
      ...
      {/* Bottom Navigation */}
      <div className="bg-[#ffffff] border-t border-[#f2f2f5] px-4 py-2">
        <div className="flex justify-around items-center">
          <Button variant="ghost" size="icon" className="p-3">
            <Home className="h-6 w-6 text-[#6b7582]" />
          </Button>
          <Button variant="ghost" size="icon" className="p-3">
            <MapPin className="h-6 w-6 text-[#121417]" />
          </Button>
          <Button variant="ghost" size="icon" className="p-3">
            <Plus className="h-6 w-6 text-[#6b7582]" />
          </Button>
          <Button variant="ghost" size="icon" className="p-3">
            <Bell className="h-6 w-6 text-[#6b7582]" />
          </Button>
          <Button variant="ghost" size="icon" className="p-3">
